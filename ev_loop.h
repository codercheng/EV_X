...
/*
extern void ev_timer_start(ev_loop_t *loop, int capacity);
extern void ev_timer_register(ev_loop_t *loop, double timeout, cb_timer_t cb, uint8_t repeat, void *ptr);
extern void ev_timer_unregister(ev_loop_t *loop, ev_timer_t *timer);
